        ...
        "application/json": {
          schema: z
            .object({
              journalists: z.array(
                z.object({
                  journalistId: z.string().uuid().openapi({ example: "a1b2c3d4-e5f6-4a7b-8c9d-0e1f2a3b4c5d" }),
                  journalistName: z.string().openapi({ example: "Sarah Perez" }).describe("Full display name of the journalist"),
                  firstName: z.string().nullable().openapi({ example: "Sarah" }),
