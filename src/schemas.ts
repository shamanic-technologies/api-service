...
export const CreateDiscoveryCampaignRequestSchema = z
  .object({
    ...
    brandUrl: z.string().min(1).describe("Brand website URL"),
    targetAudience: z.string().min(1).describe("Composed description of discovery target (e.g. 'Industry: SaaS. Angles: fundraising. Geo: US')"),
    industry: z.string().min(1).describe("Industry or sector to discover outlets in (e.g. 'SaaS', 'Fintech', 'Healthcare')"),
    angles: z.array(z.string()).optional().describe("PR angles for the discovery (e.g. ['fundraising', 'product launch', 'thought leadership'])"),
    targetGeo: z.string().optional().describe("Geographic focus for the discovery (e.g. 'US', 'Europe', 'Global')"),
