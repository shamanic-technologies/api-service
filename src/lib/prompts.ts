...
/**
 * Ensure the cold-email prompt is registered for the given org.
 * Idempotent — safe to call on every campaign creation.
 */
export async function ensureColdEmailPrompt(headers: Record<string, string>): Promise<void> {
