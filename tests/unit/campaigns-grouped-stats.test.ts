    ...
    mockCallExternalService.mockImplementation((service: any) => {
      if (service.url === "http://mock-email-gw") {
        return Promise.resolve({
          groups: [{
            key: "c1",
            broadcast: { emailsContacted: 8, emailsSent: 5, emailsDelivered: 5, emailsOpened: 3, emailsClicked: 0, emailsReplied: 1, emailsBounced: 0, repliesPositive: 0, repliesNegative: 0, repliesNeutral: 0, repliesAutoReply: 0, repliesDetail: { interested: 0, meetingBooked: 0, closed: 0, notInterested: 0, wrongPerson: 0, unsubscribe: 0, neutral: 0, autoReply: 0, outOfOffice: 0 } },
            transactional: { emailsContacted: 200, emailsSent: 100, emailsDelivered: 95, emailsOpened: 60, emailsClicked: 10, emailsReplied: 20, emailsBounced: 5, repliesPositive: 0, repliesNegative: 0, repliesNeutral: 0, repliesAutoReply: 0, repliesDetail: { interested: 0, meetingBooked: 0, closed: 0, notInterested: 0, wrongPerson: 0, unsubscribe: 0, neutral: 0, autoReply: 0, outOfOffice: 0 } },
          }],
        });
      }
