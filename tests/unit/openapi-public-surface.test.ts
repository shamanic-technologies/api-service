...
const PLATFORM_OPERATIONS = [
  ...
  "get /v1/instantly/ops/lifecycle-rules",
  "get /v1/instantly/ops/domains",
  "get /v1/instantly/ops/mailboxes",
  "get /v1/instantly/ops/addresses",
  "get /v1/instantly/ops/infra",
